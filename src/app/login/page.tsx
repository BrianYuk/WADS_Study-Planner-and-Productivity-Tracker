...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <div className="page">
        <div className="left">
          <Link href="/" className="logo"><div className="logo-icon">📚</div><div className="logo-text">Study<span>Planner</span> AI</div></Link>
        ...
        <div className="right">
          <div className="card">
            ...
            <button className="demo" onClick={()=>{setEmail('demo@studyplanner.ai');setPassword('Demo1234!')}}>🎮 Fill Demo Credentials</button>
