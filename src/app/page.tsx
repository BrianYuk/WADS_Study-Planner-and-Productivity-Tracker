  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p className="hero-p">Smart task prioritization, an AI study assistant, and adaptive scheduling — study smarter and stress less.</p>
      ...
      <div className="ai-sect">
        <div className="ai-inner">
          <div className="ai-t">
            ...
            {[{title:'Urgency + Importance scoring',desc:'Weighs due dates, priority tags, and effort.'},{title:'Study Q&A assistant',desc:'Ask Kira questions and get clear, step-by-step explanations.'},{title:'Schedule optimization',desc:'Applies spaced repetition and cognitive load balancing.'}].map(f=>(
          ...
          <div className="ai-preview">
            ...
            <div style={{marginTop:12,fontSize:11,color:'#334155',fontFamily:"'DM Mono',monospace"}}>✓ Llama 3.3 70B · 1.2s</div>
          </div>
        </div>
      </div>
      ...
      <footer><span>© 2026 Kira Flow · BINUS University International · COMP6703001</span><span>Built with Next.js · PostgreSQL · Groq</span></footer>
    </>
  )
}
