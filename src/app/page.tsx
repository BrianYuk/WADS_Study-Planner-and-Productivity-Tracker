...
export default function LandingPage() {
  return (
    <>
      ...
      <nav>
        <Link href="/" className="nav-logo"><div className="logo-icon">📚</div><div className="logo-text">Study<span>Planner</span> AI</div></Link>
      ...
      <footer><span>© 2026 StudyPlanner AI · BINUS University International · COMP6703001</span><span>Built with Next.js · PostgreSQL · OpenAI</span></footer>
    </>
  )
}
