...
**Application Name:** Kira Flow

**Reason for selection:**  
Every student in our group faces the challenge of juggling multiple subjects, deadlines, and limited study time. Existing tools like Notion or Google Calendar require manual effort and offer no AI-driven guidance. Kira Flow addresses this by combining intelligent task prioritization, burnout prevention, and adaptive scheduling into one coherent platform.
