...
This week covers **frontend component testing** and **unit testing** for Kira Flow. Tests are written using **Jest** and **React Testing Library**, following the AAA pattern (Arrange, Act, Assert).
